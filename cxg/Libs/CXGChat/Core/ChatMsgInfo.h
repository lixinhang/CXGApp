...
#define ERR_ROOMID_INVALID      "无效的房间ID"

#define ERR_UNPERMISSION        "未授权"
#define ERR_ROOMFULL            "房间人数已达上限"
#define ERR_UNKNOW_CHATROOM     "聊天服务器未找到对应的房间"
#define ERR_ENTER_KICKOUT       "不能进入已被踢出的房间"
#define ERR_KICKOUT             "被踢出房间"
#define ERR_STOP_KICKOUT        "阻止踢人"
#define ERR_USER_UNSPEAK        "用户禁言"
#define ERR_FORBID_SPEAK        "新手60s内禁止发言"
