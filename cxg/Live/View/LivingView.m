...
- (UIButton*)closeButton{
    ...
    if(!_closeButton){
        ...
        //位置
        _closeButton.frame = CGRectMake(SCREEN_W - padding * 2, padding, padding, padding);
...
- (UIButton*)cameraButton{
    if(!_cameraButton){
        ...
        //位置
        _cameraButton.frame = CGRectMake(SCREEN_W - padding * 4, padding, padding, padding);
...
- (UIButton*)startLiveButton{
    if(!_startLiveButton){
        ...
        //位置
        _startLiveButton.frame = CGRectMake((SCREEN_W - 200) * 0.5, SCREEN_H - 100, 200, 40);
        ...
        [_startLiveButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id sender) {
            ...
            if(_self.startLiveButton.selected){
                ...
                stream.url = @"rtmp://push.wscdn.cxg.changyou.com/show/123456789";
